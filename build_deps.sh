...
cd ../box2d; cmake -DENABLE_OPENGL=OFF -DBUILD_GUICHAN_OPENGL_SHARED=OFF -DBOX2D_BUILD_SHARED=ON -DBOX2D_BUILD_STATIC=OFF -DBOX2D_BUILD_EXAMPLES=OFF -DBOX2D_INSTALL=OFF .; make 
cd ../fann; cmake .; make
make -C ../kmlocal 
make -C ../json_spirit
make -C ../LuaJIT-2.0.3
